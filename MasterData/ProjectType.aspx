<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="ProjectType.aspx.cs" Inherits="ProjectType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function AddItem() {
            location.href = "ProjectType.aspx?mode=1";
        }
        function EditItem(id) {
            location.href = "ProjectType.aspx?mode=2&id=" + id;
        }
        function deleteItem(id) {
            if (confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "ProjectType.aspx?mode=3&id=" + id;
        }
        function Cancel() {
            location.href = "ProjectType.aspx";
        }
        function Cktxt(m) {
            var ck = 0;
            var txtProjectType = $get("<%=txtProjectType.ClientID%>");
            var ErrorProjectType = $get("ErrorProjectType");
                        ...
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหาประเภทโครงการ</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                            ...
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();"
                                    Text="       สร้างประเภทโครงการใหม่" ToolTip="สร้างประเภทโครงการใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="ประเภทโครงการ">
                                        <ItemTemplate>
                                            <a href="javascript:;" onclick="EditItem('<%#Eval("ProjectTypeID") %>');">
                                                <%#Eval("ProjectTypeName") %></a>
                                        </ItemTemplate>
                                    ...
                                    <Control:TemplateField HeaderText="ลบ">
                                        <ItemTemplate>
                                            <a href="javascript:deleteItem('<%#Eval("ProjectTypeID") %>');">
                    ...
                    <asp:View ID="edit" runat="server">
                        <div id="table1" class="PageManageDiv">
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    <asp:TextBox CssClass="txtBoxL" ID="txtProjectType" runat="server" Width="600px"></asp:TextBox>
                                    <span class="ColorRed">*</span>
                                    <span id="ErrorProjectType" class="ErrorMsg">กรุณาป้อนประเภทโครงการ</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                ...
                                <div class="classButton">
                                    <div class="classBtSave">
                                        <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       บันทึก"
                                            OnClick="btSave_Click" OnClientClick="return Cktxt();" ToolTip="บันทึกประเภทโครงการนี้" />
                                    </div>
