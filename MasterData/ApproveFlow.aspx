...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function deleteItem(id) {
            if (confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "ApproveFlow.aspx?mode=3&id=" + id;
        }
        function Cancel() {
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                        ...
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหาFlow การอนุมัติ</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                            ...
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();"
                                    Text="       สร้างFlow การอนุมัติใหม่" ToolTip="สร้างFlow การอนุมัติใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="Flow การอนุมัติ">
                                        <ItemTemplate>
                    ...
                    <asp:View ID="edit" runat="server">
                        <div id="table1" class="PageManageDiv">
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ชื่อ Flow การอนุมัติ : </span>
                                </div>
                                <div class="divB_Head">
                                    <asp:TextBox CssClass="txtBoxL" ID="txtApproveFlow" runat="server" Width="600px"></asp:TextBox>
                                    <span class="ColorRed">*</span>
                                    <span id="ErrorApproveFlow" class="ErrorMsg">กรุณาป้อนชื่อ Flow การอนุมัติ</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                ...
                                <div class="classButton">
                                    <div class="classBtSave">
                                        <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       บันทึก"
                                            OnClick="btSave_Click" OnClientClick="return Cktxt();" ToolTip="บันทึกFlow การอนุมัตินี้" />
                                    </div>
