                    ...
                    <asp:View ID="view" runat="server">
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหาตัวชี้วัดตามกลยุทธ์องค์กร KPI</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                            ...
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();"
                                    Text="       สร้างตัวชี้วัดตามกลยุทธ์องค์กร KPI ใหม่" ToolTip="สร้างตัวชี้วัดตามกลยุทธ์องค์กร KPI ใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server" PageSize="20">
                                <Columns>
                                    <Control:TemplateField HeaderText="ตัวชี้วัดที่">
                                        <ItemTemplate>
                                            <%# Container.DataItemIndex + 1 %>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="10%" />
                                    </Control:TemplateField>
                                    <Control:TemplateField HeaderText="ตัวชี้วัดตามกลยุทธ์องค์กร KPI">
                                        <ItemTemplate>
                    ...
                    <asp:View ID="edit" runat="server">
                        <div id="table1" class="PageManageDiv">
                            ...
                            <div class="inputrowH">
                                    ...
                                    <div class="divB_Head">
                                        <asp:DropDownList CssClass="ddl" ID="ddlStrategies" Width="500px" runat="server"
                                            AutoPostBack="true" OnSelectedIndexChanged="ddlStrategies_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    ...
                                    <span id="ErrorSort" class="ErrorMsg">กรุณาป้อนตัวชี้วัดที่</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ชื่อตัวชี้วัดตามกลยุทธ์องค์กร KPI : </span>
                                </div>
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtCorporateStrategy" CssClass="txtBoxL txt500" MaxLength="200" runat="server"></asp:TextBox>&nbsp;<span
                                        class="ColorRed">*</span> <span id="ErrorCorporateStrategy" class="ErrorMsg">กรุณาป้อนชื่อตัวชี้วัดตามกลยุทธ์องค์กร KPI</span>
                                </div>
                            </div>
                             <div class="inputrowH">
                                <div class="divF_Head">
                                ...
                                <div class="classButton">
                                    <div class="classBtSave">
                                        <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       บันทึก" OnClick="btSave_Click"
                                            OnClientClick="return Cktxt(1);" ToolTip="บันทึกตัวชี้วัดตามกลยุทธ์องค์กร KPIนี้" />
                                        <asp:Button ID="btSaveAgain" CssClass="btYesToo" runat="server" Text="       บันทึกและสร้างตัวชี้วัดตามกลยุทธ์องค์กร KPIใหม่"
                                            OnClick="btSaveAgain_Click" OnClientClick="return Cktxt(1);" ToolTip="บันทึกตัวชี้วัดตามกลยุทธ์องค์กร KPIนี้และสร้างตัวชี้วัดตามกลยุทธ์องค์กร KPIใหม่" />
                                    </div>
                            ...
                            <div class="gridViewDiv">
                                <Control:DataGridView ID="GridView2" runat="server" Visible="false" PageSize="20">
                                    <Columns>
                                        <Control:BoundField HeaderText="ตัวชี้วัดที่" DataField="Sort">
                                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                                        </Control:BoundField>
                                        <Control:BoundField HeaderText="ชื่อตัวชี้วัดตามกลยุทธ์องค์กร KPI" DataField="CorporateStrategyName">
