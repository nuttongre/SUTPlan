    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="pageDiv">
                ...
                <div class="headTable">
                    คัดลอกมาตรฐาน/ตัวบ่งชี้/ประเด็นการประเมิน
                </div>
                                ...
                                <div class="centerDiv">
                                    <div class="classButton">
                                        ...
                                        <div class="classBtCancel">
                                            <input type="button" class="btNo" value="      ไม่คัดลอก" title="ไม่คัดลอกมาตรฐาน/ตัวบ่งชี้/ประเด็นการประเมิน" onclick="Cancel();" />
                                        </div>
                                    </div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    ...
                                    <Control:BoundField HeaderText="มาตรฐาน" DataField="SideC">
                                        <ItemStyle Width="30%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                    <Control:BoundField HeaderText="ตัวบ่งชี้" DataField="StandardC">
                                        <ItemStyle Width="30%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                    <Control:BoundField HeaderText="ประเด็นการประเมิน" DataField="IndicatorsC">
                                        <ItemStyle Width="30%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                </Columns>
