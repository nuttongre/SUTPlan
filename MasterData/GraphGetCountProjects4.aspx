<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="GraphGetCountProjects4.aspx.cs" Inherits="GraphGetCountProjects4" %>
    ...
    <div id="pageDiv">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="headTable">
                    รายงานคุณภาพโครงการ/กิจกรรมตามแผนงาน
                </div>
                ...
                <div class="divMainGraph">
                    ...
                    <div class="divGraph" style="width: 99%; height:auto;">
                        ...
                        <div class="divSpntxtHeadGraph">
                            <img src="../Image/Icon/IconGraph.png" />
                            ตารางรายงานคุณภาพโครงการ / กิจกรรมตามแผนงาน
                        </div>
                            ...
                            <Control:DataGridView ID="GridView1" runat="server" ShowFooter="true" PageSize="50">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="%">
                                        <ItemTemplate>
                                            <%# decimal.Parse(Eval("data3").ToString()).ToString("#,##0.00")%> %
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="14%" />
                                        <FooterStyle HorizontalAlign="Center" Font-Bold="true" Font-Size="12pt"
                                            BackColor="#cecece" BorderStyle="Solid" BorderColor="gray" BorderWidth="2" />
                                    </Control:TemplateField>
                                    <Control:TemplateField HeaderText="สรุปไตรมาส">
                                        <ItemTemplate>
                                            <%# GetTotalAmount4(int.Parse(Eval("data4").ToString())).ToString()%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="14%" />
                                        <FooterTemplate>
                                            <%# GetSumTotalAmount4().ToString()%>
                                        </FooterTemplate>
                                        <FooterStyle HorizontalAlign="Center" Font-Bold="true" Font-Size="12pt"
                                            BackColor="#cecece" BorderStyle="Solid" BorderColor="gray" BorderWidth="2" />
                                    </Control:TemplateField>
