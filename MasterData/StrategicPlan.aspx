                        ...
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหาตัวชี้วัดระดับสำนัก KPI</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                            ...
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();"
                                    Text="       สร้างตัวชี้วัดระดับสำนัก KPI ใหม่" ToolTip="สร้างตัวชี้วัดระดับสำนัก KPI ใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server" PageSize="20">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="ชื่อตัวชี้วัดระดับสำนัก KPI">
                                        <ItemTemplate>
                        ...
                        <div id="table1" class="PageManageDiv">
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    ...
                                    <span id="ErrorDepartment" class="ErrorMsg">กรุณาเลือกหน่วยงาน</span>
                                </div>
                            </div>
                            ...
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ชื่อตัวชี้วัดระดับสำนัก KPI : </span>
                                </div>
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtStrategicPlan" CssClass="txtBoxL txt400" MaxLength="200" runat="server"></asp:TextBox>&nbsp;<span
                                        class="ColorRed">*</span> <span id="ErrorStrategicPlan" class="ErrorMsg">กรุณาป้อนชื่อตัวชี้วัดระดับสำนัก KPI</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                            ...
                            <div class="gridViewDiv">
                                <Control:DataGridView ID="GridView2" runat="server" Visible="false" PageSize="20">
                                    <Columns>
                                        ...
                                        <Control:BoundField HeaderText="ชื่อตัวชี้วัดระดับสำนัก KPI" DataField="StrategicPlanName">
