<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="GraphGetCountProjects3.aspx.cs" Inherits="GraphGetCountProjects3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function printRpt2(mode, type, id) {
            window.open("../GtReport/Viewer.aspx?rpt=" + mode + "&id=" + id + "&rpttype=" + type + "&ckSign=false&ckLogo=false");
        }
    </script>
    ...
    <div id="pageDiv">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="headTable">
                    เปรียบเทียบงบประมาณตามแผนกับงบประมาณที่ใช้จริง
                </div>
                ...
                <div class="divMainGraph">
                    ...
                    <div id="divGraph2" class="divGraph" style="width: 99%; height: 500px;">
                        ...
                        <div class="divSpntxtHeadGraph">
                            ...
                            เปรียบเทียบ งบประมาณตามแผนกับงบประมาณที่ใช้จริง
                        </div>
                    ...
                    <div class="divGraph" style="width: 99%; height:auto;">
                        ...
                        <div class="divSpntxtHeadGraph">
                            <img src="../Image/Icon/IconGraph.png" />
                            ตารางเปรียบเทียบ งบประมาณตามแผนกับงบประมาณที่ใช้จริง
                        </div>
                        <div style="margin: 0 auto; width: 99%;">
                            <Control:DataGridView ID="GridView1" runat="server" ShowFooter="true" PageSize="50">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="งบอนุมัติตั้งขึ้น">
                                        <ItemTemplate>
                                            <%# GetTotalAmount1(int.Parse(Eval("data1").ToString())).ToString("#,##0.00")%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" Width="20%" />
                                        <FooterTemplate>
                                            <%# GetSumTotalAmount1().ToString("#,##0.00")%>
                                        </FooterTemplate>
                                        <FooterStyle HorizontalAlign="Right" Font-Bold="true" Font-Size="12pt"
                                            BackColor="#cecece" BorderStyle="Solid" BorderColor="gray" BorderWidth="2" />
                                    </Control:TemplateField>
                                    <Control:TemplateField HeaderText="งบค่าใช้จ่ายจริง">
                                        <ItemTemplate>
                                            <%# GetTotalAmount2(int.Parse(Eval("data2").ToString())).ToString("#,##0.00")%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" Width="20%" />
                                        <FooterTemplate>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="DataGridView1" runat="server" ShowFooter="true" PageSize="30">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="งบค่าใช้จ่ายจริง">
                                        <ItemTemplate>
                                            <%# GetRealBudget(Eval("ProjectsCode").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Width="11%" />
                                        <FooterTemplate>
                                            <%# GetTotalRealBudget().ToString("N2")%>
                                        </FooterTemplate>
                                        <FooterStyle HorizontalAlign="Right" Font-Bold="true" Font-Size="12pt"
                                            BackColor="#cecece" BorderStyle="Solid" BorderColor="gray" BorderWidth="2" />
                                    </Control:TemplateField>
                                    ...
                                    <Control:TemplateField HeaderText="ใบคำขอ" HeaderToolTip="ใบคำขอ">
                                        <ItemTemplate>
                                            <a href="javascript:;" <%# new BTC().getLinkReportWEP("W") %> onclick="printRpt2(56,'w','<%#Eval("ProjectsCode")%>');">
                                            ...
                                            <a href="javascript:;" <%# new BTC().getLinkReportWEP("E") %> onclick="printRpt2(56,'e','<%#Eval("ProjectsCode")%>');">
                                            ...
                                            <a href="javascript:;" <%# new BTC().getLinkReportWEP("P") %> onclick="printRpt2(56,'p','<%#Eval("ProjectsCode")%>');">
