                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    ...
                    <asp:View ID="edit" runat="server">
                        <div id="Div2" class="PageManageDiv">
                            ...
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ตัวชี้วัด ตามกลยุทธ์องค์กร(KPI) :</span>
                                </div>
                                <div class="divB_Head">
                                    ...
                                    <span id="ErrorIndicators" class="ErrorMsg">กรุณาป้อนตัวชี้วัด ตามกลยุทธ์องค์กร(KPI)</span>
                                </div>
                            </div>
                            <div class="spaceDiv"></div>
                            ...
                            <div class="gridViewDiv">
                                <Control:DataGridView ID="GridViewIndicators" runat="server" AutoGenerateCheckList="true"
                                    ...
                                    <Columns>
                                        <Control:TemplateField HeaderText="ตัวชี้วัด ตามกลยุทธ์องค์กร(KPI)">
                                            <ItemTemplate>
