...
public partial class GraphGetCountProjects2 : System.Web.UI.Page
{
    BTC btc = new BTC();
    ...
    {
        string link = " <a href=\"javascript:;\" " + btc.getLinkReportWEP("W") + "  onclick=\"printRpt(61,'w');\"> "
                    ...
                    + " <a href=\"javascript:;\" onclick=\"printRpt(61,'e');\"> "
                    ...
                    + " <a href=\"javascript:;\" " + btc.getLinkReportWEP("P") + " onclick=\"printRpt(61,'p');\"> "
    ...
    void ReportGraph(string ChartName, DataView dv, int mode)
    {
        ...
        {
            Suffix = "numberSuffix=''";
            string[] column = { "โครงการตามแผน=data", "โครงการอนุมัติ=data1", "เปอร์เซ็นต์คุณภาพโครงการ=data2" };
