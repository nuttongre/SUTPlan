<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="GraphGetCountProjects.aspx.cs" Inherits="GraphGetCountProjects" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function printRpt(mode, type) {
            ...
            window.open("../GtReport/Viewer.aspx?rpt=" + mode + "&rpttype=" + type + "&monthB=" + MonthB + "&quarter=" + Quarter + "&yearB=" + YearB + "&ckLogo=false&ckSign=false");
        }
                        ...
                        <div style="margin: 0 auto; width: 99%;">
                            <Control:DataGridView ID="GridView1" runat="server" ShowFooter="true" PageSize="50">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="จำนวนโครงการนำเสนอ">
                                        <ItemTemplate>
                                    ...
                                    <Control:TemplateField HeaderText="จำนวนโครงการอนุมัติ">
                                        <ItemTemplate>
                                    ...
                                    <Control:TemplateField HeaderText="จำนวนโครงการยกเลิก">
                                        <ItemTemplate>
                                            <%# GetTotalAmount2(int.Parse(Eval("data2").ToString())).ToString()%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="20%" />
                                        <FooterTemplate>
                                            <%# GetSumTotalAmount2().ToString()%>
                                        </FooterTemplate>
                                        <FooterStyle HorizontalAlign="Center" Font-Bold="true" Font-Size="12pt"
                                            BackColor="#cecece" BorderStyle="Solid" BorderColor="gray" BorderWidth="2" />
                                    </Control:TemplateField>
                                    <Control:TemplateField HeaderText="จำนวนโครงการยังไม่อนุมัติ">
                                        <ItemTemplate>
                                            <%# GetTotalAmount3(int.Parse(Eval("data3").ToString())).ToString()%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="20%" />
                                        <FooterTemplate>
                                            <%# GetSumTotalAmount3().ToString()%>
                                        </FooterTemplate>
                                        <FooterStyle HorizontalAlign="Center" Font-Bold="true" Font-Size="12pt"
                                            BackColor="#cecece" BorderStyle="Solid" BorderColor="gray" BorderWidth="2" />
                                    </Control:TemplateField>
                            ...
                            <Control:DataGridView ID="DataGridView1" runat="server" ShowFooter="true" PageSize="30">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="สถานะ">
                                        <ItemTemplate>
                                            <%# GetstatusIsApprove(Eval("ProjectsCode")) %>
                                        </ItemTemplate>
