...
--เพิ่มฟิว กลุ่มเป้าหมาย
If Not Exists(Select * From Sys.Columns Where Object_ID = Object_ID('Projects') And Name = 'TargetGroup')
Begin
	alter table Projects add TargetGroup nVarchar(300)
End
--เพิ่มฟิว วิทยากร
If Not Exists(Select * From Sys.Columns Where Object_ID = Object_ID('Projects') And Name = 'Lecturer')
Begin
	alter table Projects add Lecturer nVarchar(300)
End
--เพิ่มฟิว หัวข้อการจัดฝึกอบรม
If Not Exists(Select * From Sys.Columns Where Object_ID = Object_ID('Projects') And Name = 'Topics')
Begin
	alter table Projects add Topics nVarchar(300)
End
--เพิ่มฟิว ผลที่คาดว่าจะได้รับ
If Not Exists(Select * From Sys.Columns Where Object_ID = Object_ID('Projects') And Name = 'ExpectedResults')
Begin
	alter table Projects add ExpectedResults nVarchar(300)
End
--เพิ่มฟิว เครือข่ายความร่วมมือภายใน
If Not Exists(Select * From Sys.Columns Where Object_ID = Object_ID('Projects') And Name = 'InternalCooperation')
Begin
	alter table Projects add InternalCooperation nVarchar(300)
End
--เพิ่มฟิว เครือข่ายความร่วมมือภายนอก
If Not Exists(Select * From Sys.Columns Where Object_ID = Object_ID('Projects') And Name = 'ExternalCooperation')
Begin
	alter table Projects add ExternalCooperation nVarchar(300)
End
